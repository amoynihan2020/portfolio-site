...
const NavBar = () =>{
    ...
    const onUpdateActiveLink = (update)=>{
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <span className='navbar-text'>
            <div className="social-icon">
                <a href="https://linkedin.com/in/adammoynihan"><img src={navIcon1}/></a>
                <a href="#"><img src={navIcon2}/></a>
                <a href="#"><img src={navIcon3}/></a>
            </div>
            <button className='vvd' onClick={() =>{console.log('HEY')}}><span>Lets Connect!</span></button>
          </span>
        </Navbar.Collapse>
      </Container>
    </Navbar>
